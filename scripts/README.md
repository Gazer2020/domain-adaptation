...
Current launcher:
- `run_experiment_suite.py`: generic batch experiment runner with JSON spec input, `screen` support, resume support, summaries, Feishu webhook notifications, and optional auto shutdown.
