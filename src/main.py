...
def main(cfg: DictConfig):
    ...
    logger.info("Available solvers: %s", list_solvers())
    ...
    log_runtime_summary(logger, runtime_cfg, seed)
    ...
    if best_saved and best_path is not None and Path(best_path).exists():
        ...
        logger.warning(
            "No checkpoint was saved. This can happen when total epochs < method.save_start_epoch "
